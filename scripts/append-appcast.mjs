 ...
 *   ZIP     - e.g. "Modelbox-v0.2.0-beta.1.zip"
 ...
 *   - Sources/Modelbox/Resources/Info.plist.template's CFBundleVersion
...
const plist = readFileSync(
  resolve(repoRoot, "Sources/Modelbox/Resources/Info.plist.template"),
  "utf8"
);
...
const releaseURL = `https://github.com/mmurakaru/modelbox/releases/download/${tag}/${zip}`;
const releaseNotesURL = `https://github.com/mmurakaru/modelbox/releases/tag/${tag}`;
...
// Insert the new item right after the channel metadata, before any existing
// <item>. If no <item> exists yet, insert before </channel>.
let updated;
